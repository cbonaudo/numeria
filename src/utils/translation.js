// Translate in french up to 999 999 999 999 999
...
export function translateNumber(figures) {
    
    let translatedNumber = "";

    for (let i = 0; i < figures.length; i++) {
        translatedNumber += figures[i];
    }

    translatedNumber = NumberToLetter(Number(translatedNumber));
    translatedNumber = translatedNumber.charAt(0).toUpperCase() + translatedNumber.slice(1);
